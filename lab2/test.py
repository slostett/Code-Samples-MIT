...
class TestTiny(unittest.TestCase):
    ...
    def test_bacon_number_3(self):
        expected = set()
        result = lab.actors_with_bacon_number(self.data, 3)
        self.assertEqual(expected, result)

    def test_bacon_path(self):
        expected = [4724, 2876, 1640]
        result = lab.bacon_path(self.data, 1640)
        self.assertEqual(expected, result)

    def test_actor_to_actor_path(self):
        expected = [4724, 2876, 1640]
        result = lab.actor_to_actor_path(self.data, 4724, 1640)
        self.assertEqual(expected, result)

    def test_actor_path(self):
        expected = [4724, 2876, 1640]
        result = lab.actor_path(self.data, 4724, lambda x: x == 1640)
        self.assertEqual(expected, result)
